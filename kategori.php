...
<div class="container mt-5">
    <div class="row">
            ...
            <div class="card">
                <div class="card-body text-center">
                	<?php
						...
						{
					?>
							<img class="img img-responsive rounded-circle mb-3" width="160" src="images/<?php echo $_SESSION['foto_pencaker'] ?>" />
        ...
        <div class="col-md-8">
            <?php $data->tampil_cari() ?>	
            <div class="card mb-3">
                <div class="card-body">
					<table summary="Summary Here" cellpadding="0" cellspacing="0">
						<?php $data->tampil_hasil_cari(['namab']) ?>
					</table>
				</div>
    		</div>
